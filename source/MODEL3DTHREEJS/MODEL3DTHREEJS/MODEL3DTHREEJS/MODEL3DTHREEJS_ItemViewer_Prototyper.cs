...
{
    public class MODEL3DTHREEJS_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        ...
        public MODEL3DTHREEJS_ItemViewer_Prototyper()
        {
            ViewerType = "MODEL3DTHREEJS";
            ViewerCode = "model3dthreejs";
        }
        ...
        {
            return new MODEL3DTHREEJS_ItemViewer(CurrentItem, CurrentUser, CurrentRequest, Tracer);
        }
    }
}